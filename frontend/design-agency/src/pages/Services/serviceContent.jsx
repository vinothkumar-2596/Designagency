export const heroSketches = [
  ...
  },
  {
    ...
    render: () => (
      <>
        <defs>
          <radialGradient id="brand-fx-glow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#fe6102" stopOpacity="0.5" />
            <stop offset="55%" stopColor="#fe6102" stopOpacity="0.16" />
            <stop offset="100%" stopColor="#fe6102" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="brand-fx-scan" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#fe6102" stopOpacity="0" />
            <stop offset="50%" stopColor="#ffd2a3" stopOpacity="0.95" />
            <stop offset="100%" stopColor="#fe6102" stopOpacity="0" />
          </linearGradient>
        </defs>

        {/* Pulsing background glow behind emblem */}
        <circle
          className="brand-fx__glow"
          cx="161" cy="109" r="78"
          fill="url(#brand-fx-glow)"
        />

        {/* Outer orbital ring — dashed, rotates slowly */}
        <g className="brand-fx__orbit brand-fx__orbit--outer">
          <circle
            cx="161" cy="109" r="86"
            stroke="#eda369" strokeWidth="1" strokeOpacity="0.55"
            strokeDasharray="3 9" fill="none"
          />
        </g>

        {/* Mid orbital ring — long dashes, rotates opposite */}
        <g className="brand-fx__orbit brand-fx__orbit--mid">
          <circle
            cx="161" cy="109" r="72"
        ...
        {/* Cardinal tick marks */}
        <g className="brand-fx__cardinal" stroke="#eda369" strokeWidth="1.5" strokeOpacity="0.85" strokeLinecap="round">
          <line x1="161" y1="14" x2="161" y2="24" />
          <line x1="161" y1="194" x2="161" y2="204" />
          <line x1="65" y1="109" x2="75" y2="109" />
          <line x1="247" y1="109" x2="257" y2="109" />
        </g>

        {/* HUD corner brackets */}
        <g className="brand-fx__corners" stroke="#ffffff" strokeWidth="1.4" strokeOpacity="0.55" fill="none" strokeLinecap="round">
          <path d="M 96 50 L 96 62 M 96 50 L 108 50" />
          <path d="M 226 50 L 226 62 M 226 50 L 214 50" />
          <path d="M 96 168 L 96 156 M 96 168 L 108 168" />
          <path d="M 226 168 L 226 156 M 226 168 L 214 168" />
        </g>

        {/* Pulse ring expanding from emblem center */}
        <circle
          className="brand-fx__pulse"
          cx="161" cy="109" r="40"
          stroke="#eda369" strokeWidth="1.5" strokeOpacity="0.75"
          fill="none"
        />

        {/* Scan line sweeping vertically over emblem */}
        <rect
          className="brand-fx__scan"
          x="106" y="54" width="110" height="2.5"
          fill="url(#brand-fx-scan)"
        />

        {/* Orbiting satellite particle */}
        <g className="brand-fx__satellite">
          <circle cx="247" cy="109" r="6" fill="#fe6102" fillOpacity="0.3" />
          <circle cx="247" cy="109" r="2.5" fill="#fe6102" />
        </g>

        {/* BrandViora emblem — outline version */}
        <g
          className="brand-fx__emblem"
          transform="translate(112 58) scale(0.19) translate(-327 -331)"
        ...
        >
          ...
          <path
            ...
            d="M668.08,867.36l-206.16-334.57h-134.89l184.8,299.9c13.7,22.23,37.95,35.78,64.07,35.78h90.39l1.8-1.11Z"
          />
          {/* Body shape */}
          <path
            stroke="#ffffff"
            strokeWidth="4"
            vectorEffect="non-scaling-stroke"
            d="M828.67,605.73c12.69-25.45,19.84-54.15,19.84-84.52,0-34.61-9.28-67.06-25.47-94.99-32.82-56.61-94.07-94.69-164.21-94.69h-322.93v57.28c0,39.34,31.89,71.22,71.22,71.22h269.08c32.52,0,58.89,26.37,58.89,58.89v.52c0,37.95-30.76,68.71-68.71,68.71h-102.01l52.99,82.16,46.76,73.07,21.62-34.39,1.3-2.07,8.05-12.81c10.05-15.98,31.15-20.79,47.13-10.75,12.78,8.03,18.4,23.13,15.02,37.03-.75,4.08-2.26,8.09-4.61,11.81l-85.97,136.27h133.58l56.34-101.53c30.32-54.63,17.22-121.61-27.9-161.21Z"
          />
        </g>

        {/* BrandViora wordmark */}
        <g transform="translate(26.8 196)" fill="#ffffff">
          <g transform="scale(0.45)">
            <path d="M140.32,55.41c0,7.36-5.57,14.62-15.1,14.62h-17.96V22.03h13.11c8.28,0,13.88,5.96,13.88,12.33,0,5.18-3.6,8.64-5.39,8.64,5.39,0,11.47,4.94,11.47,12.42ZM114.77,29.35v11.97l5.96-.03c3.72.03,6.46-2.53,6.46-5.96s-2.98-5.99-6.37-5.99h-6.05ZM132.96,54.91c0-3.63-3.1-6.97-8.55-6.97l-9.65.03v14.71h9.77c4.32,0,8.43-3.13,8.43-7.77Z" />
            ...
            <path d="M227.38,62.74h-22.73l-3.28,7.3h-8.16l22.58-49h.45l22.58,49h-8.16l-3.28-7.3ZM224.46,56.28l-8.43-18.76-8.46,18.76h16.89Z" />
            <path d="M287.82,21.91v48.97h-.36l-30.71-32.08v31.3h-7.54V21.19h.39l30.65,32.02v-31.3h7.57Z" />
            ...
            <path fill="#fe6102" d="M388.96,22.03l-22.16,49h-.51l-22.07-49h8.01l14.3,32.5,14.36-32.5h8.07Z" />
            <path d="M399.36,22.03h7.54v48.01h-7.54V22.03Z" />
            <path d="M402.94,17.03h0c0-3.41-2.76-6.17-6.17-6.17h0c3.41,0,6.17-2.76,6.17-6.17h0c0,3.41,2.76,6.17,6.17,6.17h0c-3.41,0-6.17,2.76-6.17,6.17Z" />
            ...
            <path d="M556.53,62.74h-22.73l-3.28,7.3h-8.16l22.58-49h.45l22.58,49h-8.16l-3.28-7.3ZM553.62,56.28l-8.43-18.76-8.46,18.76h16.89Z" />
          </g>
        </g>
